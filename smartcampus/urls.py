...
from users_ai.views import (
    user_login, user_register, user_logout, homepage, dashboard,
    ai, ai_chat_api,
    todo_add, todo_edit, todo_delete, todo_toggle,
)
from users_ai.admin_views import admin_login, admin_logout, admin_dashboard

from cafeteria.views import (
    cafeteria, add_to_cart, update_cart_item, remove_from_cart,
    cart_view, confirm_order, order_now, my_orders,
...
from events.views import (
    events, register_for_event, unregister_from_event, my_registered_events,
